...
describe('Set-1: Fee Filter', () => {
  ...
  // Tests that the function returns an array datatype
  it('Datatype test : Function returns an array', () => {
    let result = feeFilter(fees, vehicle[0]);
    expect(Object.prototype.toString.call(result)).to.eql('[object Array]');
  });
});
