...
describe('Set-1: Vehicle Match', () => {
  ...
  // from the beging of an array with mutiple values
  ...
  it('Array mid Test : Function returns expected keys from array', () => {
  ...
  it('Array end Test : Function returns expected keys from array', () => {
